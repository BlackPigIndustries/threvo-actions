...
!!! note "Release availability"
    ...
    These commands install the immutable `0.6.2` release after the signed tag
...
=== "AWS KMS protection"
    ...
    ```bash
    uv add "threvo-actions[aws-kms]==0.6.2"
    ```
...
=== "PostgreSQL"
    ...
    ```bash
    uv add "threvo-actions[postgres]==0.6.2"
    ```

=== "MySQL"

    ```bash
    uv add "threvo-actions[mysql]==0.6.2"
    ```
...
=== "SQLAlchemy and Alembic"
    ...
    ```bash
    uv add "threvo-actions[sqlalchemy]==0.6.2"
    ```
...
=== "Pydantic AI"
    ...
    ```bash
    uv add "threvo-actions[pydantic-ai]==0.6.2"
    ```
