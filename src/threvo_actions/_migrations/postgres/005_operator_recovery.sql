ALTER TABLE __THREVO_ACTIONS_SCHEMA__.proposals
DROP CONSTRAINT proposals_lifecycle_status_check;

ALTER TABLE __THREVO_ACTIONS_SCHEMA__.proposals
ADD CONSTRAINT proposals_lifecycle_status_check CHECK (
    lifecycle_status IN (__THREVO_ACTIONS_LIFECYCLE_STATUSES__)
);
