...
REQUIRED_PACKAGE_FILES = {
    ...
    "threvo_actions/integrations/stripe/billing_testing.py",
    "threvo_actions/integrations/stripe/composition.py",
    "threvo_actions/integrations/stripe/conformance.py",
    ...
    "threvo_actions/integrations/stripe/postgres.py",
    "threvo_actions/integrations/stripe/postgres_conformance.py",
    "threvo_actions/integrations/stripe/postgres_migrations.py",
    "threvo_actions/integrations/local_kek.py",
    "threvo_actions/integrations/stripe/recovery.py",
    "threvo_actions/integrations/stripe/sdk_gateway.py",
    "threvo_actions/integrations/stripe/subscriptions.py",
    "threvo_actions/integrations/stripe/testing.py",
