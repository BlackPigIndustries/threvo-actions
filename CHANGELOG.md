...
- Permit supported `trialing` Stripe subscriptions to schedule or withdraw
  period-end cancellation under the existing authority, reservation, and
  verification checks.

### Documentation

- Define trial-period cancellation eligibility and preserve the distinction
  between a period-end schedule and immediate termination.
...
[Unreleased]: https://github.com/BlackPigIndustries/threvo-actions/compare/v0.6.2...HEAD
[0.6.2]: https://github.com/BlackPigIndustries/threvo-actions/compare/v0.6.1...v0.6.2
